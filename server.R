  ...
  output$data_table <- renderTable({
    ...
    output$data_plot <- renderPlot({
      ...
      if (dgraf == "By Year"){
        ...
        graf1 <- barplot(dat.by.year$Total_Cases,names.arg=dat.by.year$Year, main="Total Dengue Cases from 2012 to 2015", xlab="Year", ylab="Total Cases", ylim=c(0,250000),col="yellow")
